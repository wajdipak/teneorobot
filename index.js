...
// Masukkan isi account.txt langsung ke dalam variabel
accounts = [
  { email: "wajdipak@gmail.com", password: "J6ABfcfLUN4g*hq" },
  { email: "wajdi.pak@gmail.com", password: "*qgx8hx*SyxSYtf" },
  { email: "wa.jdipak@gmail.com", password: "sFrTdave!6mdLCt" }
];

// Masukkan isi proxy.txt langsung ke dalam variabel
proxies = [
  "173.0.9.70:5653",
  "ojpwlhzo:ryxgwd9pn05g@173.0.9.70:5653",
  "http://173.0.9.70:5653",
  "http://ojpwlhzo:ryxgwd9pn05g@173.0.9.70:5653"
];
...
function promptUseProxy() {
    return new Promise((resolve) => {
        displayHeader();
        const useProxy = false; // Langsung menetapkan pilihan "n"
        console.log('Do you want to use a proxy? (y/n): n');
        resolve(useProxy);
    });
}
...
function promptEnableAutoRetry() {
  return new Promise((resolve) => {
    const enableAutoRetry = true; // Langsung menetapkan pilihan "y"
    console.log('Do you want to enable auto-retry for account errors? (y/n): y');
    resolve(enableAutoRetry);
  });
}
